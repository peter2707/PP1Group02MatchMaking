...
$viewUser = $uc->getUserByName("employer", $username);
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-secondary"><?php echo "$viewUser->position"; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary text-start">
                                        <?php echo "<input disabled type='text' class='form-control' value='$viewUser->email' />"; ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary text-start">
                                        <?php echo "<input disabled type='text' class='form-control' value='$viewUser->phone' />"; ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary text-start">
                                        <?php echo "<input disabled type='text' class='form-control' value='$viewUser->dob' />"; ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary text-start">
                                        <?php echo "<input disabled type='text' class='form-control' value='$viewUser->position' />"; ?>
                                    </div>
                                </div>
                                <hr>
